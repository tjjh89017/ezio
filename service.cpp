...
gRPCService::gRPCService(std::string listen_address = "0.0.0.0:50051") : server_address(listen_address)
{
...
Status EZIOServiceImpl::Shutdown(ServerContext* context, const Empty *e1, Empty *e2)
{
	// TODO fix this
...
Status EZIOServiceImpl::AddTorrent(ServerContext* context, const AddRequest* request, AddResponse* response)
{
	...
	const lt::bdecode_node node = lt::bdecode(torrent_byte, ec, nullptr, depth_limit, token_limit);
